...
directories_sm = {
    'em' : {
    '0' : ['muTau_nobtag', 'mutau', 'nobtag', 'cmb'],
    '1' : ['emu_btag', 'emu', 'btag', 'cmb'],
    '2' : ['emu_nobtag', 'emu', 'nobtag', 'cmb'],
    '3' : ['muTau_btag', 'mutau', 'btag', 'cmb'],
    '4' : ['eleTau_btag', 'etau', 'btag', 'cmb'],
    '5' : ['eleTau_nobtag' , 'etau', 'nobtag', 'cmb'],
    },
    'et' : {
    '0' : ['1jet', 'vbf', 'htt', 'cmb'],
    '1' : ['1jet', 'vbf', 'htt', 'cmb'],
