...
layout = cms.PSet(
    ...
    dataset = cms.string("CMS Preliminary, #sqrt{s} = 8 TeV, bba_{1} #rightarrow bb#tau#tau, L = 19.7 fb^{-1}"),
    #dataset = cms.string("CMS Preliminary, #sqrt{s} = 7 TeV, A#rightarrow Zh#rightarrow ll#tau#tau, L = 4.9 fb^{-1}"),
    ## x-axis title
    xaxis = cms.string("m_{a1} [GeV]"),
    ## x-axis title
    yaxis = cms.string("95% CL #sigma(bba_{1}#rightarrowbb#tau#tau) [pb]"),
    ## plot expected only
